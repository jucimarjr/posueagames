...
//		   }
	...
	setupPlayer: function (posX, posY) {
        ...
        dropSprite.body.createGroupCallback(this.lifeDropCG, this.checkOverlapWithLifeDrop, this);
	...
	setupShell: function () {
		 // Create sea shell
        this.seashell = this.game.add.sprite(450, this.game.world.height - 106, 'seashell');

...
var game = new Phaser.Game(600, 1020, Phaser.AUTO, 'phaser-game', { preload: preload, create: create, update: update });

function preload () {
	//game.stage.backgroundColor = "#ffffff";
	game.load.tilemap('mapa','assets/labMap.json',null,Phaser.Tilemap.TILED_JSON);
...
function create () {
	...
	map.setCollisionBetween(4,4, true,'Camada de Tiles 1'); // 0 espaco vazio 1 em diante os tiles do tileset
    ...
    dino = game.add.sprite(460 ,1900 ,'dino', 3);

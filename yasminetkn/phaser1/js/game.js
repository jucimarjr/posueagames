...
function preload () {
	...
	game.load.image('floor', 'assets/floor_960-600.png');
    game.load.image('ground', 'assets/background_960-600.png');
...
function create () {
    ...
    bonecoSprite.body.acceleration.y = 100;
    ...
    bonecoSprite.body.gravity.y = 150;

...
var game = new Phaser.Game(1200, 960, Phaser.AUTO, 'phaser-game', { preload: preload, create: create, update: update });

function preload () {
	//game.stage.backgroundColor = "#ffffff";
	game.load.tilemap('mapa','assets/teste_vertical.json',null,Phaser.Tilemap.TILED_JSON);
    game.load.spritesheet('dino', 'assets/littleduck_40-40-4.png', 40,40,4); // 200x160 eh o tamanho do frame da sprite
	game.load.image('coxa', 'assets/coxa.png');
	game.load.image('fundo', 'assets/fundo_1920-600.jpg');
   	game.load.image('tile1','assets/tileset.png');
   	game.load.image('tile2','assets/tile-02.png');
}
...
function create () {
    ...
    var bg = game.add.tileSprite(0,0,1200,960,'fundo');
    bg.fixedToCamera = true;

	
    map = game.add.tilemap('mapa');
	map.addTilesetImage('tilesets','tile1');

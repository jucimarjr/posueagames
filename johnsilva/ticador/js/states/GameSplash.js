...
State.GameSplash.prototype = {
	preload: function () {
		...
		*/
		//Game
		this.game.load.spritesheet('player', 'assets/sprites/player_200-150-2.png', 200,150,2);
		this.game.load.spritesheet('fish2', 'assets/sprites/fish2_90-120-3.png',90,120,3);

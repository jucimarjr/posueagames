...
Config.level = {
	getLevel: function(level){
		...
		if(level == 1)
		    ...
		    Config.update.updateLevel(65, 600, true, 13, 0, 18, 0, 22, 23, 'coinIara', 31,0,0);
		else if(level == 3)
		    Config.update.updateLevel(65, 600, true, 13, 18, 19, 23, 24, 25, 'coin', 33,0,0);
		else if (level == 4)
		    Config.update.updateLevel(75, 650, true, 13, 18, 19, 23, 24, 25, 'coinIara', 33,0,0);
		else if (level == 5)
		    Config.update.updateLevel(75, 2050, true, 13, 18, 19, 23, 24, 25, 'coin', 33,0,0);
		else if (level == 9)

BasicGame.Missions = function () {
	...
	this._events = [
		...
		{ type: BasicGame.Missions.Event.AskForDate, name: 'ask 4 date', isUnique: true },
		{ type: BasicGame.Missions.Event.RegularDate, name: 'regular date' },
		{ type: BasicGame.Missions.Event.NiceDate, name: 'nice date' },
		{ type: BasicGame.Missions.Event.AskForKiss, name: 'ask 4 kiss', isUnique: true },
		{ type: BasicGame.Missions.Event.Kiss, name: 'kiss' },
		{ type: BasicGame.Missions.Event.Argument, name: 'argument' },
		{ type: BasicGame.Missions.Event.ChangedFacebookStatus, name: 'changed status', isUnique: true },
		...
		{ type: BasicGame.Missions.Event.DineWithFamily, name: 'family dinner' },
		{ type: BasicGame.Missions.Event.CantGetItUp, name: 'limp sex' },
		...
		{ type: BasicGame.Missions.Event.RenewVows, name: 'renew vows', isUnique: true },
		{ type: BasicGame.Missions.Event.NoSex, name: 'month with 0 sex' },
		{ type: BasicGame.Missions.Event.GotOld, name: 'time passes...', isUnique: true },
		{ type: BasicGame.Missions.Event.GrandChild, name: 'grandchild' },
		{ type: BasicGame.Missions.Event.HealthProblem, name: 'disease' },
		{ type: BasicGame.Missions.Event.Death, name: 'your time has come', isGameOver: true }
	];
